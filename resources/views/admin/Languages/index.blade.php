...
@section('content')
	...
	<a class="btn btn-primary mb-5" href="{{ route('admin.language.create') }}" role="button">ADD</a>
	...
	<div class="row">
		@foreach ($languages as $language)
			<div class="card col-3 text-center">
				<div class="card-body">
					<h2 class="card-title">
						<a href="{{ route('admin.language.show', $language) }}"
							class="link-underline link-underline-opacity-0">{{ $language->name }}</a>
						<i class="{{ $language->icon }} "></i>
					</h2>
					<a class="btn btn-secondary" href="{{ route('admin.language.edit', $language->id) }}" role="button">M</a>
